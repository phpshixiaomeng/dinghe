    ...
    <div id="right_ctn">
        <div class="right_m">
            ...
            <div class="hy_list">
                ...
                <!--终端列表-->
                <form action="/admin/gameimg/{{ $gamexg->id }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                    <div class="xjhy">
                        <!--基本配置-->
                        <ul class="hypz">
                            ...
                            <li class="clearfix">
                                ...
                                <div class="li_r">
                                    <select name="gname" style="width:190px;height:27;"> 
                                            <option value="{{ $gamexg->gname }}">{{ $gamexg->gname }}</option>
                                    </select>
                                    <i>*</i>
                                </div>
                            </li>
                            ...
                            <li class="clearfix" style="height:100px">
                                <span class="title">游戏详情图片：</span>
                                <div class="li_r xial">
                                    <div class="xial_w xial_l">
                                        <input type="file" name="game_img" multiple id="" style="height:100px">
