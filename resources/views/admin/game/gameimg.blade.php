                ...
                <form action="#" method="post">
                    <table class="search list_hy">
                        <tr>
                            ...
                            <th scope="col" style="text-align: center">游戏详情图片</th>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center"><img src="/uploads/{{ $value->game_img }}" style="width:50px;height:50px;"></td>

                            </td>
                            <td style="text-align: center">
                                <a href="/admin/gameimg/delete/{{ $value->id }}" class="btn btn-danger" onclick="return confirm('确定要删除吗?')">删除</a>
                                <a href="/admin/gameimg/{{ $value->id }}/edit" class="btn btn-warning">修改</a>
                            </td>
                        </tr>
                        @endforeach
