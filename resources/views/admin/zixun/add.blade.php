    ...
    <div id="right_ctn">
        <div class="right_m">
            ...
            @endif
                ...
                <!--终端列表-->
                <form action="/admin/zixun" method="post" enctype="multipart/form-data">
                    <div class="xjhy">
                        <!--基本配置-->
                        @if (count($errors) > 0)
                        <div id="alert" class="alert alert-danger alert-dismissible" role="alert">
                        ...
                        <ul class="hypz">
                            ...
                            <li class="clearfix">
                                <span class="title">资讯作者：</span>
                                <div class="li_r">
                                    <input name="auth" value="{{old('gname')}}" type="text">
