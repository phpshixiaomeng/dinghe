    ...
    <div id="right_ctn">
        <div class="right_m">
            ...
            <div class="hy_list">
                ...
                <!--查询-->
                <form action="/admin/wall" method="get">
                    <div class="search">
                        <span>按壁纸名称查询：</span>
                        <div class="s_text">
                       ...
                       @foreach($wall as $k=>$v)
                        <tr>
                            ...
                            <td style="text-align: center">
                                <a href="/admin/wall/delete/{{ $v->id }}" class="btn btn-danger" onclick="return confirm('确定要删除吗?')">删除</a>
                                <a href="/admin/wall/{{ $v->id }}/edit" class="btn btn-warning">修改</a>
                            </td>
                        </tr>
                        @endforeach
