         ...
         <div class="hy_list">
            ...
            <form  action="/admin/video" method="get">
                <div class="search">
                    ...
                    <span style="float:right; font:18px/1.2 '微软雅黑';margin-right: 100px;margin-top: 20px;" >总共<b style="color:red;" >{{ $num }}</b>条视频</span>
                </div>
            </form>
            ...
            <table  class="search list_hy">
                <tr>
                    ...
                    <th scope="col">标题</th>
                    <th scope="col">视频缩略图</th>
                    <th scope="col">视频连接</th>
                    <th scope="col">状态</th>
                    <th scope="col">操作</th>
                </tr>
            ...
            @foreach($data as $val)
                <tr>
                    ...
                    <td>
                        @if( $val->status == 1 )
                            <a href="/admin/video/status/{{ $val->id }}/0"><img style="width:20px" src="/admin_assets/images/links/dui.jpg"></a>
                        @else
                            <a href="/admin/video/status/{{ $val->id }}/1"><img style="width:20px" src="/admin_assets/images/links/cuo.jpg"></a>
                        @endif
                    </td>
                    <td>

                        <form style="float:left" action="/admin/video/{{ $val->id }}" method="post">
                            {{ csrf_field() }}
                            {{ method_field('DELETE') }}
                ...
                <div class="r_foot" style="margin-bottom: 30px">
                    <div class="r_foot_m">
                         ...
                         <span style="width:100px;float:left;margin-top:5px;">
                            <form method="post" id="qdel" action="/admin/video/del">
                                {{ csrf_field() }}
